...
class MagazinesControllerTest < ActionController::TestCase
  ...
  test "should create magazine" do
    assert_difference('Magazine.count') do
      post :create, magazine: { description: @magazine.description, published_at: @magazine.published_at, title: @magazine.title }
    end
  ...
  test "should update magazine" do
    put :update, id: @magazine, magazine: { description: @magazine.description, published_at: @magazine.published_at, title: @magazine.title }
    assert_redirected_to magazine_path(assigns(:magazine))
  end
